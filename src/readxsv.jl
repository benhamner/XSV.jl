...
fiterxsvht(xsv_file::String; delimiter=',', quotechar='"', strtype="ascii"::String) = @task _iterxsvht(open(xsv_file), delimiter=delimiter, quotechar=quotechar, strtype=strtype, close_io=true)
